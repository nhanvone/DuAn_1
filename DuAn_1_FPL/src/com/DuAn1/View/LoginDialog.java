...
//            MsgBox.alert(this, "Không được để trống !");
            ...
            //gọi cái from TBLoi len.
            LoiFrame loi = new LoiFrame();
            // set NoiDUng thong bao loi
            loi.setErrorMessage("Bạn đã chưa nhập tài khoản hoặc mật khẩu mà :<");
            //show tb loi len
            loi.show();
            return;
        } else if (nv == null) {
            LoiFrame loi = new LoiFrame();
            loi.setErrorMessage("Bạn đã nhập sai tài khoản hoặc mật khẩu mất rồi :<");
            loi.show();
            return;
