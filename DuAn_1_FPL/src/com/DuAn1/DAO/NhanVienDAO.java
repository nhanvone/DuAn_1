 ...
 * @author sonmi
 */
public class NhanVienDAO extends QuanLyTraSuaDAO<NhanVien, String> {

    String insert = "INSERT INTO NhanVien(MaNhanVien,TenNhanVien,NgaySinh,GioiTinh,SoDienThoai,NgayVaoLam,ChucVu,TenTaiKhoan,MatKhau,Hinh) VALUES(?,?,?,?,?,?,?,?,?,?)";
    ...
    String selectbyId = "SELECT *FROM NhanVien WHERE TenTaiKhoan = ?";

    @Override
    public void insert(NhanVien entity) {
        JDBCHelper.update(insert, entity.getMaNV(),entity.getTenNV(),entity.getNgaySinhDate(),entity.isGoiTinh()
        ,entity.getSoDienThoai(), entity.getNgayVaoLamDate(),entity.getChucVu(),entity.getTaiKhoan(),entity.getMatKhau()
        ,entity.getHinh());
    }

    @Override
    public void update(NhanVien entity) {
        JDBCHelper.update(update, entity.getMaNV(),entity.getTenNV(),entity.getNgaySinhDate(),entity.isGoiTinh()
        ,entity.getSoDienThoai(), entity.getNgayVaoLamDate(),entity.getChucVu(),entity.getTaiKhoan(),entity.getMatKhau()
        ,entity.getHinh());
    }
    ...
    protected List<NhanVien> selectbySql(String sql, Object... args) {
        ...
        try {
            ...
            while(rs.next()){
                ...
                nv.setGoiTinh(rs.getString("GioiTinh"));
